...
public class WebSecurityConfig {
     ...
     * <p>
     * Current policy: all endpoints ({@code /**}) are permitted without
     * authentication.
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // // User controller: limit GET /users and /users/by-username/** to ADMIN,
                // STAF_LAPANGAN, and STAF_TOKO
                ...
                // .requestMatchers(HttpMethod.GET, "/users/**")// custom logic in controller to
                // check if user is accessing their own data or is staff/admin
                // .hasAnyAuthority("ADMIN", "STAF_LAPANGAN", "STAF_TOKO", "MEMBER", "GUEST",
                // "OWNER")
                )
